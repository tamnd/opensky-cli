...
Most of these come down to network reality or how opensky serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

opensky rate-limits like any public site. opensky already paces
...
Where a surface is gated, opensky reads a cookie or token you supply
...
`opensky`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what opensky actually did
