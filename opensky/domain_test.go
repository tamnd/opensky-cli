...
// HTTP behaviour is covered in opensky_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "opensky://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("opensky", "about")
	if err != nil || got.String() != "opensky://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want opensky://page/about", got.String(), err)
	}
}
